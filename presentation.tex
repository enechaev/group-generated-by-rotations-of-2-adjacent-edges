...
\begin{frame}
	\frametitle{Обозначения. Группа кубика Рубика}
	\RubikCubeSolved
	\RubikRotation{y3,z3}
	\begin{figure}
		\ShowCube{10cm}{1}{
			\DrawRubikCubeLU
            \node[text=green] (L) at (1.5,1.5) {\huge{$L$}};
            \node[text=green] (U) at (-0.5,2) {\Large{$U$}};
		}
	\end{figure}
    $G_{cube}\subset S_{48}$.
    
    Инварианты:
    \begin{enumerate}
        \item Сумма углов поворотов угловых кубиков делится на 360\textdegree.
        \item Сумма углов поворотов реберных кубиков делится на 360\textdegree.
        \item Четность перестановок угловых и реберных кубиков совпадает.
    \end{enumerate}
\end{frame}
...
\begin{figure}[c]
	...
	\centering
	\caption{\small{Классы пар угловых кубиков\label{possibleperms}}}
\end{figure}
\column{.54\textwidth}
\begin{figure}[c]
	\centering
...
\begin{itemize}
	...
	%А так как $(A_5\times A_7)\cap \langle((1~2),(1~2))\rangle=\{(e,e)\}$ и группа $A_5\times A_7$ нормальна, группа $C_p$ представляется в виде полупрямого произведения $(A_5\times A_7)\rtimes\mathbb{Z}_2$ с тривиальным гомоморфизмом $\phi:\mathbb{Z}_2\rightarrow Aut(A_5\times A_7) (\cong S_5\times S_7)$.
\end{itemize}
